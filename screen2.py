...
def pay():
    ...
    button=tkinter.Button(cur,text="PROCEED TO PAY Rs.799",bg="red",fg="white",font=("titan romans",10,"bold"),command=pay)
...
x=tkinter.Label(cur,text="NETFLIX",font=("bebas neue",28),fg="red",bg="white")    
y=Button(cur,text="Sign In",font=("bebas neue",(10),"bold"),fg="white",bg="red",command=())
z=tkinter.Label(cur,text="STEP 1 OF 3",bg="white")
q=tkinter.Label(cur,text="CHOOSE YOUR PLAN.",bg="white",font=("bebas neue",20))
photo=PhotoImage(file="plans final3.png")
image=Label(cur,image=photo)
mo=Button(cur,text="MOBILE",font=("bebas neue",(9),"bold"),bg="red",fg="white",command=())
ba=Button(cur,text="BASIC",font=("bebas neue",(9),"bold"),bg="red",fg="white")
st=Button(cur,text="STANDARD",font=("bebas neue",(9),"bold"),bg="red",fg="white")
pr=Button(cur,text="PREMIMUM",font=("bebas neue",(9),"bold"),bg="red",fg="white",command=pay)
...
mo.place(x=247,y=410)
ba.place(x=347,y=410)
